<div id="zoodpay_form">
    <input type="submit" id="button-confirm" class="btn btn-primary" value="<?php echo $submit; ?>">
</div>
<?php if ($zoodpay_error): ?>
    <div id="message_error" class="alert alert-warning"><i class="fa fa-info-circle"></i>
        <?php foreach ($zoodpay_error as $error) { ?>
            Zoodpay <?php echo $error; ?>
           <?php } ?></div>
<?php endif; ?>
