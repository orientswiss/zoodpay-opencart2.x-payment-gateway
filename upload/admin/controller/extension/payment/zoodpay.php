...
class ControllerExtensionPaymentZoodPay extends Controller
{
    ...
    public function index()
    {
        ...
        $data['text_additional_tab'] = $this->language->get('text_additional_tab');
        $data['entry_environment'] = $this->language->get('entry_environment');
        $data['healthcheck'] = $this->language->get('healthcheck');
        $data['entry_merchant_key'] = $this->language->get('entry_merchant_key');
        $data['entry_merchant_secret'] = $this->language->get('entry_merchant_secret');
        $data['entry_merchant_salt_key'] = $this->language->get('entry_merchant_salt_key');
        ...
        $data['healthcheck_success'] = $this->language->get('healthcheck_success');
        $data['entry_healthcheck'] = $this->language->get('entry_healthcheck');
        $data['error_healthcheck_url'] = $this->language->get('error_healthcheck_url');



        //Added for the Status

        $data['text_order_status_tab'] = $this->language->get('text_order_status_tab');
        ...
        $data['entry_refund_initiated_status'] = $this->language->get('entry_refund_initiated_status');
        $data['entry_refund_approved_status'] = $this->language->get('entry_refund_approved_status');
        $data['entry_refund_declined_status'] = $this->language->get('entry_refund_declined_status');
        ...
        $data['entry_merchant_tc'] = $this->language->get('entry_merchant_tc');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $this->model_setting_setting->editSetting('zoodpay', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'], true);
...
//        }
        ...
        if (isset($this->request->post['zoodpay_status'])) {
            $data['status'] = $this->request->post['zoodpay_status'];
        } else {
            $data['status'] = $this->config->get('zoodpay_status');
        }
        ...
        foreach ($results as $result) {
            ...
            $data['orders'][] = array(
                ...
                'view' => $this->url->link('sale/order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . '&zoodpay=true' . $url, true),
            );
        }
        ...
        $data['sort_order'] = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, true);
        $data['sort_customer'] = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, true);
        $data['sort_status'] = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'] . '&sort=order_status' . $url, true);
        $data['sort_total'] = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, true);
        $data['sort_date_added'] = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, true);
        $data['sort_date_modified'] = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'] . '&sort=o.date_modified' . $url, true);
        ...
        $pagination->url = $this->url->link('extension/payment/zoodpay', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    ...
    public function history() {
        ...
        $pagination->page = $page;
        $pagination->limit = 10;
        $pagination->url = $this->url->link('extension/payment/zoodpay/history', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'] . '&page={page}', true);
