<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fa fa-cog"></i> <?php echo $heading_modal_title; ?></h4>
        </div>
        <div class="modal-body">
            <fieldset>
                <legend><?php echo $textarea_legend; ?></legend>
                ...
                <a data-toggle="tooltip" data-method="<?php echo $method; ?>" title="<?php echo $button_save; ?>"
...
<script type="text/javascript"><!--
    ...
    $('.btn-modal').on('click', function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: 'index.php?route=extension/payment/zoodpay/' + method + '&token=<?php echo $token; ?>',
            type: 'post',
            data: 'amount=<?php echo $amount; ?>&order_id=<?php echo $order_id; ?>&comment1=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
            dataType: 'json',
            beforeSend: function () {
